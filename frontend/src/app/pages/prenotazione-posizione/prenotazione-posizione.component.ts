...
export class PrenotazionePosizioneComponent implements OnInit {
  ...
  workspacesDatabase: WorkspaceData[] = [
    ...
    { id: "A26-75", name: "A26 - Postazione 75", floor: "Stanza A26", type: "Postazione - Giornata intera" },
    { id: "A26-76", name: "A26 - Postazione 76", floor: "Stanza A26", type: "Postazione - Giornata intera" },
    { id: "A26-77", name: "A26 - Postazione 77", floor: "Stanza A26", type: "Postazione - Giornata intera" },
    { id: "A26-78", name: "A26 - Postazione 78", floor: "Stanza A26", type: "Postazione - Giornata intera" },
    { id: "A26-79", name: "A26 - Postazione 79", floor: "Stanza A26", type: "Postazione - Giornata intera" },
    { id: "A26-80", name: "A26 - Postazione 80", floor: "Stanza A26", type: "Postazione - Giornata intera" },
    ...
    { id: "A20-10", name: "A20 - Postazione 10", floor: "Stanza A20", type: "Postazione - Giornata intera" },
  ...
  generateMarkersForFloor(floorName: string, availableWorkspaces: string[]): FloorPlanMarker[] {
    ...
    const roomCoordinates: Record<string, { x: number; y: number; workstations: string[] }> = {
      "Stanza A1": { x: 60, y: 680, workstations: ["A1 - Postazione 30", "A1 - Postazione 31"] },
      "Stanza A2": { x: 60, y: 600, workstations: ["A2 - Postazione 32", "A2 - Postazione 33"] },
      "Stanza A3": { x: 60, y: 520, workstations: ["A3 - Postazione 34", "A3 - Postazione 35"] },
      "Stanza A4": { x: 60, y: 440, workstations: ["A4 - Postazione 39", "A4 - Postazione 40"] },
      "Stanza A5": { x: 60, y: 360, workstations: ["A5 - Postazione 41", "A5 - Postazione 42"] },
      "Stanza A6": { x: 60, y: 280, workstations: ["A6 - Postazione 43", "A6 - Postazione 44"] },
      "Stanza A7": { x: 60, y: 200, workstations: ["A7 - Postazione 45", "A7 - Postazione 46"] },
      "Stanza A8": { x: 60, y: 120, workstations: ["A8 - Postazione 49", "A8 - Postazione 50", "A8 - Postazione 51"] },
      "Stanza A9": {
        x: 140,
        y: 60,
        workstations: ["A9 - Postazione 52", "A9 - Postazione 53", "A9 - Postazione 54", "A9 - Postazione 55"],
      },
      "Stanza A10": {
        x: 220,
        y: 80,
        workstations: ["A10 - Postazione 56", "A10 - Postazione 57", "A10 - Postazione 58"],
      },
      "Stanza A11": { x: 300, y: 80, workstations: ["A11 - Postazione 51"] },
      "Stanza A12": { x: 420, y: 80, workstations: ["A12 - Postazione 52"] },
      "Stanza A13": { x: 500, y: 80, workstations: ["A13 - Postazione 53", "A13 - Postazione 54"] },
      "Stanza A14": { x: 580, y: 80, workstations: ["A14 - Postazione 55"] },
      "Stanza A15": { x: 660, y: 80, workstations: ["A15 - Postazione 59"] },
      "Stanza A16": {
        x: 740,
        y: 200,
      ...
      "Stanza A17": {
        x: 800,
        y: 260,
        workstations: ["A17 - Postazione 10", "A17 - Postazione 11", "A17 - Postazione 12", "A17 - Postazione 13"],
      },
      "Stanza A18": { x: 800, y: 480, workstations: ["A18 - Postazione 17", "A18 - Postazione 18"] },
      "Stanza A19": { x: 740, y: 480, workstations: ["A19 - Postazione 19"] },
      "Stanza A20": { x: 680, y: 520, workstations: ["A20 - Postazione 20"] },
      "Stanza A21": { x: 680, y: 600, workstations: ["A21 - Postazione 21"] },
      "Stanza A22": {
        x: 580,
        y: 520,
        workstations: ["A22 - Postazione 20", "A22 - Postazione 21", "A22 - Postazione 22", "A22 - Postazione 23"],
      },
      "Stanza A23": { x: 300, y: 680, workstations: ["A23 - Postazione 24"] },
      "Stanza A24": { x: 220, y: 680, workstations: ["A24 - Postazione 25"] },
      "Stanza A25": { x: 140, y: 680, workstations: ["A25 - Postazione 26"] },
      "Stanza A26": {
        x: 300,
        y: 560,
        workstations: [
      ...
      "Stanza A27": {
        x: 220,
        y: 240,
        workstations: ["A27 - Postazione 60", "A27 - Postazione 61", "A27 - Postazione 62", "A27 - Postazione 63"],
      },
      "Stanza A28": { x: 340, y: 240, workstations: ["A28 - Postazione 64"] },
      "Stanza A29": {
        x: 420,
        y: 240,
        workstations: ["A29 - Postazione 65", "A29 - Postazione 66", "A29 - Postazione 67"],
      },
      "Stanza A30": { x: 500, y: 200, workstations: ["A30 - Postazione 68", "A30 - Postazione 69"] },
      "Stanza A31": {
        x: 340,
        y: 400,
        workstations: ["A31 - Postazione 66", "A31 - Postazione 67", "A31 - Postazione 68"],
      },
      "Stanza A32": { x: 420, y: 360, workstations: ["A32 - Postazione 72", "A32 - Postazione 73"] },
